...
export default function ResponsiveAppBar() {
  ...
  const renderMobileMenu = (
    ...
    >
      <MenuItem onClick={(e) => handleOpenMenu(e, 'room')}>Products</MenuItem>
  ...
  const renderDropdownMenu = (
    <>
      ...
      >
        <MenuItem onClick={() => handleProductNavigation('product1')}>Choose your room</MenuItem>
        <MenuItem onClick={() => handleProductNavigation('roombooking')}>Room Booking</MenuItem>
        <MenuItem onClick={() => handleProductNavigation('product3')}>Room Payment</MenuItem>
      </Menu>
